            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         <i class="menu-icon fas fa-box-open">
                             </i> Pembelian Material</a>
                    <ul class="sub-menu children dropdown-menu fa-ul">
                            <li><i class="fas fa-puzzle-piece"></i><a href="{{route('purchasingmaterial')}}">Form Pembelian Material</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{route('purchasedata')}}">Data Pembelian Material</a></li>
                ...
                @else
                <h3 class="menu-title">Production Inventory</h3>
                <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             <i class="menu-icon fas fa-box-open">
                                 </i> Inventory Lists</a>
                        <ul class="sub-menu children dropdown-menu fa-ul">
                                <li><i class="fas fa-puzzle-piece"></i><a href="#">badges</a></li>
